...
def generate_terrain_map(width, height, terrains, terrain_fractions=None, seed=None, num_gaussians=8):
    """
    Generate a terrain map from Gaussian heightmap.
    ...
    heightmap = generate_gaussian_map(width, height, num_gaussians=num_gaussians, seed=seed)
...
if __name__ == "__main__":
    ...
    food = Resource("food", color=(255,0,0), abundance=0.1)
    wood = Resource("wood", color=(139,69,19), abundance=1.0)
    stone = Resource("stone", color=(228,228,228), abundance=1.0)
    ...
    terrains = {
        "water": Terrain("water", color=(0,0,255), resources=[Resource("food", color=(255,0,0), abundance=0.1)]),
